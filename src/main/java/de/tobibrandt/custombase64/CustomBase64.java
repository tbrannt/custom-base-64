...
/**
 * This class provides the functionality to encode/decode a byte array to/from a Base64 String.<br>
 * This Base64 class does NOT follow the RFC 3548 or RFC 4648 specification of Base64 as the used charset can be specified and no padding characters are 
 * used.<br>
